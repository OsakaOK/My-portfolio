...
const RecentProjects = () => {
  return (
    <div className='py-20' id="projects">
        ...
        <div className='flex flex-wrap iterms-center
        justify-center p-4 gap-x24 gap-y-8 mt-10'>
            {projects.map(({id, title, des, img, iconLists, link})=>(
                <div key={id} className='sm:h-[41rem] lg:min-h-[32.5rem] 
                    ...
                    <PinContainer title={link} href={link}>
                        ...
                        justify-between mt-7 mb-3'>
                            ...
                            <div className='flex justify-center items-center'>
                                <p className='flex lg:text-xl md:text-xs text-sm text-purple'>Check Github Repo</p>
