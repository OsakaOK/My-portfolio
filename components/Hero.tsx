    ...
    <div className='pb-20 pt-36'>
        ...
        flex items-center justify-center absolute top-0 left-0">
            <div className="absolute pointer-events-none inset-0 flex items-center justify-center
             dark:bg-black-100 bg-white [mask-image:radial-gradient(ellipse_at_center,
             transparent_20%,black)]" />
        </div>

        <div className='flex justify-center relative my-20 z-10'>
            <div className='max-w-[89] md:max-w-2xl lg:max-w-[60vw] flex flex-col
            items-center justify-center'>
                ...
                <TextGenerateEffect
                    ...
                    words="You can do ANYTHING but not EVERYTHING"
                />

                <p className='text-center md:tracking-wider mb-4
                text-sm md:text-lg lg:text-2xl'>
                    Hi, I'm Osaka, a recent graduated Computer Science student from Wilfrid Laurier Univeristy.
                </p>
